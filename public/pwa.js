(() => {
  ...
  async function notifyPendingOnOpen() {
    ...
    const registration = await navigator.serviceWorker.ready;
    registration.active?.postMessage({ type: 'SHOW_NOTIFICATION', payload: { title: `TeamFlow \u00b7 ${reminders.length} \u4e2a\u5f85\u8ddf\u8fdb`, body: overdue ? `\u5176\u4e2d ${overdue} \u4e2a\u5df2\u903e\u671f\uff0c\u70b9\u51fb\u67e5\u770b\u3002` : '\u6709\u4e8b\u9879\u5373\u5c06\u5230\u671f\uff0c\u70b9\u51fb\u67e5\u770b\u3002', tag: `teamflow-${today}`, url: '/#tracking' } });
  }
